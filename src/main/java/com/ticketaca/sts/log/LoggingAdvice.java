...
public class LoggingAdvice {
	...
	// // target 메서드의 파라미터등 정보를 출력.
	// @Before("execution(* com.team2.internet.*.*(..))")
	...
	// }
	//
	// @After("execution(* com.team2.internet.*.*.*.*(..))")
	...
	@Around("execution(* com.ticketaca.sts.*.*.*(..))")
	public Object timeLog(ProceedingJoinPoint pjp) throws Throwable {
		...
		Object result = pjp.proceed(); // proceed는 Exception 보다 상위 Throwable을
										// 처리해야 한다.
